...
<body>
                        ...
                        <div class="navbar-nav ms-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu m-0">
                                    <a href="wedding.php" class="dropdown-item active">Wedding</a>
    ...
    <div class="container-fluid page-header py-5">
        <h1 class="text-center text-white display-6 wow fadeInUp" data-wow-delay="0.1s">Wedding Events</h1>
        <ol class="breadcrumb justify-content-center mb-0 wow fadeInUp" data-wow-delay="0.3s">
            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
            <li class="breadcrumb-item"><a href="#">Our Events</a></li>
            <li class="breadcrumb-item active text-white">Wedding</li>
        </ol>
    </div>
            ...
            <div class="row g-4">
                <div class="col-lg-6 wow fadeInLeft" data-wow-delay="0.2s">
                    <a href="tel:8220184674" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                        <div>
                            <h3 class="text-primary">Planning for your big day?</h3>
                            <p class="text-muted mb-3">Let's make it stress-free & memorable</p>
                            <h4 class="text-secondary mb-0">Book a free consultation</h4>
                        </div>
                    </a>
                </div>
                <div class="col-lg-6 wow fadeInRight" data-wow-delay="0.3s">
                    <a href="#" class="d-flex align-items-center justify-content-between border bg-white rounded p-4">
                        <div>
                            <h3 class="text-primary">Complete Event Combo</h3>
                            <p class="text-muted mb-3">Engagement + Wedding + Reception</p>
                            <h4 class="text-secondary mb-0">Book your big day with us</h4>
                        </div>
                    </a>
                </div>
            </div>
        ...
        <div class="container products-mini py-5">
            <div class="mx-auto text-center mb-5" style="max-width: 700px;">
                <h4 class="text-primary mb-4 border-bottom border-primary border-2 d-inline-block p-2 title-border-radius wow fadeInUp"
                    data-wow-delay="0.1s">Wedding Packages</h4>
                        ...
                        <div>
                            <div>
                                <div class="products-mini-img border-end h-100">
                                    <img src="img/Weddingpackage.png" class="img-fluid w-100 h-100" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
...
<form id="bookingForm">
        ...
        <div class="step-content">
          ...
          <input class="form-control text-center" id="selectedPackage" name="Package" readonly>
        ...
        <div class="container products-mini py-5">
            <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                <h4 class="text-primary border-bottom border-primary border-2 d-inline-block p-2 title-border-radius wow fadeInUp"
                    data-wow-delay="0.1s">Wedding Highlights</h4>
            </div>
                ...
                <div class="productImg-carousel owl-carousel productList-item">
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-7">
                                <div class="products-mini-img border-end h-100">
                                    <img src="img/c1.JPG" class="img-fluid w-100 h-100" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="productImg-carousel owl-carousel productList-item">
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-7">
                                <div class="products-mini-img border-end h-100">
                                    <img src="img/hh1.JPG" class="img-fluid w-100 h-100" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="productImg-carousel owl-carousel productList-item">
                    <div class="productImg-item products-mini-item border">
                        <div class="row g-0">
                            <div class="col-7">
                                <div class="products-mini-img border-end h-100">
                                    <img src="img/w5.JPG" class="img-fluid w-100 h-100" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
